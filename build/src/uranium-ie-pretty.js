(function() {
  ...
  function wrap(xhtml, tag) {
    var attributes = {}, re = /^<([A-Z][A-Z0-9]*)([^>]*)>(.*)<\/\1>/i, element, x, a, i = 0, attr, node, attrList;
    if(re.test(xhtml)) {
  ...
  xui.extend({touch:eventSupported("ontouchstart"), on:function(type, fn) {
    return this.each(function(el) {
  ...
  xui.extend({setStyle:function(prop, val) {
    ...
    return callback === undefined ? getStyle(this[0], prop) : this.each(function(el) {
    ...
    return callback === undefined && this.length == 1 ? hasClass(this[0], className) : this.length && this.each(function(el) {
