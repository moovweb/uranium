...
Ur.WindowLoaders["carousel"] = (function() {
  ...
  Carousel.prototype = {
    initialize: function() {
      ...
      var images = x$(this.container).find("img[data-ur-carousel-component='item'], [data-ur-carousel-component='item'] img");
      ...
      images.each(function(img) {
        if (img.useMap) {
          x$("map[name='" + img.useMap.substring(1) + "']").each(function(map) {
            self.initSwipeHandlers(map);
          });
        }
      });
