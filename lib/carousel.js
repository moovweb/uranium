...
(function(){
  ...
  Carousel.prototype = {
    ...
    resize: function(){
      // Check if this container's size has changed

      // When I have multi-item carousels, I'll just need to need to make snap_width a method
      if (this.snap_width != this.container.offsetWidth) {
        console.log("MY SIZE CHANGED!");
        this.adjust_spacing();
      }
    },
