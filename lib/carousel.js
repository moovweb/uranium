(function(){
  ...
  Carousel.prototype = {
	...
	this.touch = true;
      ...
      // I think this is unecessary -- the momentum function always seems to terminate properly, and now I just check this.increment_flag
    ...
    adjust_spacing: function() {
      ...
      var images = x$(this.items).find("img"); // This should probably be a uranium-style selector
      this.item_count = images.length;
      x$().iterate(
        images,
        function(image, i) {
