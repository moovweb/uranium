...
Ur.WindowLoaders['carousel'] = (function(){
  ...
  Carousel.prototype = {
    ...
    update_buttons: function() {
      console.log("current idx", this.item_index, "last index:", this.last_index);
...
//      if ( this.destination_offset < -1*(this.item_count - 1)*this.snap_width || this.destination_offset > 0 ) {
      if ( this.destination_offset < -1*(this.last_index - 1)*this.snap_width || this.destination_offset > 0 ) {
