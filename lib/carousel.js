...
//      asdf234589u;.l43
    ...
    {
      console.log("swipe started", this.increment_flag);
      ...
      console.log("start raw coords:", coords);
      if(coords !== null)
      {
    ...
    {      
      ...
      {    
        ...
        console.log("swipe:", swipe_distance);
        if (this.multi) {
          // Sigmoid FTW:
        ...
        console.log("displacement index:", displacement_index);
    ...
    snap_to: function(displacement) {
      ...
      if ( this.destination_offset < max_offset || this.destination_offset > 0 ) {
        console.log("capping offset!");
        if (Math.abs(this.destination_offset - max_offset) < 1) {
          // Hacky -- but there are rounding errors
          // See this when I'm in multi-mode and using the buttons
          // This only seems to happen on the desktop browser?
          console.log("hacky hackerton");
//          this.destination_offset = max_offset;
    ...
    move_helper: function(direction){
      var new_idx = this.item_index - direction;
      console.log("intiail new idx:", new_idx);
      ...
      console.log("current idx:", this.item_index);
      console.log("updating idx to:", new_idx);
    ...
    momentum: function()
    {
      ...
      //console.log("distance:", distance, "xt:", x_transform);
      var increment = distance - zero_floor(distance / 1.1);
//      console.log("increment", increment);
//  carousel.js:383increment 0.000010172526060614473
