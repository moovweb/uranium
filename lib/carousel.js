...
//        this.start_pos = coords;
        ...
        console.log("prev dest:" + this.destination_offset);
        console.log("this pos:" + x_transform);
        ...
        if(this.starting_offset === undefined) {
          ...
          console.log("old swip dist:" + this.swipe_dist() + "," + this.start_pos.x);
          var swipe_difference = this.start_pos.x - coords.x;
//          this.start_pos = coords;
          console.log("swipe diff:" + swipe_difference);
          var momentum_difference = this.destination_offset - x_transform;
          console.log("new swip dist:" + this.swipe_dist() + "," + this.start_pos.x);
          
          this.starting_offset = x_transform + momentum_difference ;// + this.swipe_dist(); // Take into account last swipe
...
//        displacement_index = zero_ceil(swipe_distance/this.snap_width);
    ...
    snap_to: function(displacement) {
      ...
      console.log("dest offset:" + this.destination_offset);
