...
Ur.WindowLoaders['carousel'] = (function(){
  ...
  Carousel.prototype = {
    ...
    adjust_spacing: function() {
      ...
      console.log("initial v width:", visible_width);
      ...
      if(this.multi) {
        ...
        this.snap_width = space / (magazine_count - 1) + item_width; //Math.ceil(space / (magazine_count - 1) + item_width);
        console.log("new snap width:",this.snap_width);
      ...
      if (this.multi) {
        console.log("visible width:",visible_width);
        console.log("# items per view:",magazine_count,"space:",space);
        x$().iterate(
          items,
          function(item, i) {
