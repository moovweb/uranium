...
Ur.QuickLoaders['SwipeToggle'] = (function () {
  ...
  function SwipeToggle (swipe_element, name){
    ...
    SwipeToggle.prototype.autoPopulate = function (autoPopulateList) {
      if (autoPopulateList === undefined) {
        ...
        for (var items in autoPopulateList) {
          x$(location).bottom(autoPopulateList[items]);
        }
  ...
  SwipeToggle.prototype.autoPopulateList = ["<div></div>", "<img src=''/>", "text", "<span></span>"]
