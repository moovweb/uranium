  ...
  function Zoom(components) {
    ...
    function initialize() {
      with(self) {
        ...
        width = width || parseInt($img.attr("width")) || parseInt($img.getStyle("width")) || img.width;
        height = height || parseInt($img.attr("height")) || parseInt($img.getStyle("height")) || img.height;
