    ...
    // for each carousel
     ...
     function Carousel(set) {
      ...
      function moveHelper(direction) {
        ...
        log(self.itemIndex + " (currentindex) item's offsetleft: " + currentItem.offsetLeft);
        log(newIndex + " (newindex) item's offsetleft: " + newItem.offsetLeft);
