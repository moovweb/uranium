  ...
  interactions.carousel = function ( fragment ) {
    ...
    function Carousel(set) {
      ...
      function moveTo(direction) {
        ...
        dest = $items[newIndex];
        $container.triggerHandler("slidestart.ur.carousel", {index: newIndex}).triggerHandler("slidestart", {index: newIndex});
      ...
      function endSnap() {
        ...
        self.flag.click = true;
        self.autoscrollStart();
        $container.triggerHandler("slideend.ur.carousel", {index: self.itemIndex}).triggerHandler("slideend", {index: self.itemIndex});
      }
